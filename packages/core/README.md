...
Unreleased follow-up (Issue #25): unchanged top-level directive wrappers are
...
Diff reconstruction preserves unchanged EOF newlines. These fixes are not in `0.1.9`.
